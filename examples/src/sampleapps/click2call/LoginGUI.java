...
public class LoginGUI extends JFrame{
	...
	private Click2Call c2c = null;

	/**
	 * Constructor used to perform JFrame setup and invoke the displaying
	 * of the Login GUI.
	 * @param instance - Click2Call class instance.
	 */
	public LoginGUI(Click2Call instance){
	...
	/**
	 * LoginHandler class used to verify the entering of a username and
	...
	/**
	 * CancelHandler class used to exit the application when cancel is
	 * pressed on the LoginGUI.
	 *
	 */
