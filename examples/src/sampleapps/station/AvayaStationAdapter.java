...
/**
 * Implements a "do nothing" callback method for the callApperanceLampUpdated
 * event.  All other events are handled by the PhysicalDeviceAdapter super class.
 *
 * @author AVAYA, Inc.
 * @version $Revision: 1.4 $
 **/

public class AvayaStationAdapter extends PhysicalDeviceAdapter 
        implements AvayaStationListener {

    public void callAppearanceLampUpdated(String lampID, Short lampMode) {
    }
